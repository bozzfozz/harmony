"""Download flow orchestrator coordinating batch submissions and workers."""
...
class DownloadFlowOrchestrator:
    """Coordinate download/enrich/move jobs with bounded concurrency."""
    ...
    async def _worker_loop(self, worker_index: int) -> None:
        try:
            ...
            self._logger.exception("download flow worker crashed", extra={"worker": worker_index})
...
__all__ = ["DownloadFlowOrchestrator", "BatchHandle"]
