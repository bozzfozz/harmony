...
import { fetchPlexStatus, fetchSettings, updateSetting } from '../lib/api';
...
type PlexSettingsForm = Record<(typeof PLEX_FIELDS)[number]['key'], string>;
...
const PlexPage = () => {
  ...
  const defaultValues = useMemo(() => {
    ...
    return PLEX_FIELDS.reduce<PlexSettingsForm>((acc, field) => {
  ...
  const handleSubmit = (values: PlexSettingsForm) => mutation.mutate(values);
