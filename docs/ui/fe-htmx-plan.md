...
| Soulseek Queue | GET `/api/v1/soulseek/downloads` | Tab-Ladevorgang, `hx-trigger="every 15s"` | `#hx-soulseek-queue` | 5xx ⇒ Fehlerbanner |【F:app/routers/soulseek_router.py†L623-L633】
